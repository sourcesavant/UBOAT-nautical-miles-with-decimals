...
#define SAMPLES_COUNT_DIV_2 SAMPLES_COUNT/2.0
#define SAMPLES_COUNT_DIV_4 SAMPLES_COUNT/4.0
#define INV_SAMPLES_COUNT 1.0/SAMPLES_COUNT
#define SHADOW_SAMPLING_AREA 0.05		// 0.06

//sampler3D _GlobalShadowJitter;
