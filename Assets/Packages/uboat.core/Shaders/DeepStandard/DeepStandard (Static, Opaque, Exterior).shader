...
Shader "Standard (DWS, Static, Opaque, Exterior)"
{
    Properties
    {
...
#define UNITY_SETUP_BRDF_INPUT MetallicSetup
		...
		Pass
		{
			...
			#pragma multi_compile_local USE_CUSTOM_AMBIENT
			...
			#pragma multi_compile_local STATIC_OPTIMIZATIONS
			#pragma multi_compile_local OPAQUE_OPTIMIZATIONS
