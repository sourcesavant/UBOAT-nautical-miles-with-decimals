...
Shader "Nature/SpeedTreeBake"
{
    ...
    SubShader
    {
        ...
        CGPROGRAM
            #pragma surface surf Standard vertex:SpeedTreeVert nodirlightmap nodynlightmap dithercrossfade fullforwardshadows
            #pragma target 3.0
    ...
    SubShader
    {
        ...
        CGPROGRAM
            #pragma surface surf Standard vertex:SpeedTreeVert nodirlightmap nodynlightmap fullforwardshadows noinstancing
            #pragma multi_compile_vertex LOD_FADE_PERCENTAGE
            #pragma shader_feature GEOM_TYPE_BRANCH GEOM_TYPE_BRANCH_DETAIL GEOM_TYPE_FROND GEOM_TYPE_LEAF GEOM_TYPE_MESH
            #pragma multi_compile_local SPEEDTREE_SHADER
            #include "SpeedTreeCommon.cginc"
