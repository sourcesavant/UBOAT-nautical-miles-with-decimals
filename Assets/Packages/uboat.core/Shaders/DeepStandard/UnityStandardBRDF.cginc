...
half4 BRDF1_Unity_PBS (half3 diffColor, half3 specColor, half oneMinusReflectivity, half smoothness,
    ...
    UnityLight light, UnityIndirect gi, half3 subsurfaceScatteringColor = 0)
{
...
#   endif
    ...
    half3 color =   diffColor * (gi.diffuse + light.color * diffuseTerm + subsurfaceScatteringColor * light.color)
