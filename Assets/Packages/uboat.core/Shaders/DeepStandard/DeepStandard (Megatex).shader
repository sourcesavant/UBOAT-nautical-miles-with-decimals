...
Shader "Standard (DWS, Megatex)"
{
    Properties
    {
        ...
        _MegatexAlbedoMap("Megatex Albedo", 2D) = "grey" {}
        _MegatexMetallicGlossMap("Megatex Metallic", 2D) = "white" {}
        ...
        _PatternRepeatDistance ("Pattern Repeat Distance", Float) = 120.0
        _MegatexIntensity ("Megatex Intensity", Range(0.0, 1.5)) = 1.0
...
#define UNITY_SETUP_BRDF_INPUT MetallicSetup
        ...
        // ------------------------------------------------------------------
        //  ForwardBase pass used for shader replacement
        Pass
        {
            Name "FORWARD"
			...
			Pass
		{
			...
			//#pragma shader_feature _ DYNAMICLIGHTMAP_ON			// it's also inside multi_compile_prepassfinal
